...
async function Post({ params: { slug } }: Props) {
  ...
  return (
    <div className="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12 ">
      <article className="!px-1 md:!px-10 pb-28">
        <a href="/blog" className="relative inline-block text-lg group mb-10 mt-10">
          <span className="relative z-10 block px-5 py-3 overflow-hidden font-medium leading-tight text-gray-800 transition-colors duration-300 ease-out border-2 border-gray-900 rounded-lg group-hover:text-white ">
            ...
            <span className="absolute left-0 w-48 h-48 -ml-2 transition-all duration-300 origin-top-right -rotate-90 -translate-x-full translate-y-12 bg-[#222] dark:bg-[#221C63] group-hover:-rotate-180 ease"></span>
        ...
        <section className="scace-y-2 border border-[#221C63] text-white">
          <div className="relative min-h-56 flex flex-col md:flex-row justify-between">
            ...
            <section className="p-5 bg-[#221C63] w-full">
