              ...
              >
                <ul className="mt-3">
                  ...
                  <li className="flex mt-2" style={{ display: "block" }}>
                    ...
                    <div className="flex">
                      <a href="https://www.facebook.com/Universal-Motors-LTD-101574801831062" target="_blank">
                        <svg
                      ...
                      <a href="https://www.instagram.com/universalmotorsltdofficial/" target="_blank">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width={16}
                          height={16}
                      ...
                      <a href="https://www.youtube.com/@universalmotorsltdofficial" target="_blank">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                      ...
                      <a className="ml-1" href="https://www.linkedin.com/company/universal-motors-ltd/" target="_blank">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width={16}
                          height={16}
